...
<body>
	<div class="container">
        <h1>게시글 수정</h1>
        <form action="/board/update" method="post" enctype="multipart/form-data"> <!-- 이미지 같이 전달 : enctype="multipart/form-data" -->
           ...
           <div class="form-group">
                ...
                <input type="text" readonly value="${vo.writer}" id="writer" name="writer" class="form-control" readonly/>
           </div>
